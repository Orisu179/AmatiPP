...
AmatiSliderParameterAttachment::AmatiSliderParameterAttachment (
    ...
    juce::Slider& s,
    juce::UndoManager* undoManager) : curParam (std::move (faustParam)),
                                      slider (s),
                                      attachment (
                                          param,
...
AmatiSliderAttachment::AmatiSliderAttachment (FaustProgram::Parameter& curParam, juce::AudioProcessorValueTreeState& valueTreeState, const juce::String& parameterID, juce::Slider& attachedSlider) : id (parameterID)
{
